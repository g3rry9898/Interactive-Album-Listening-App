...
const albumData = {
  id: '1',
  title: 'Alligator Bites Don\'t Heal',
  artist: 'DoeChii',
  cover: 'https://example.com/alligator-bites-dont-heal-cover.jpg', // Placeholder for album cover
  genre: 'Hip-Hop',
  year: '2024',
  duration: '45:15',
  tracks: 14,
  description: 'A raw and emotional journey through pain, resilience, and self-discovery. DoeChii\'s debut album showcases her unique blend of melodic rap and introspective lyricism, creating a powerful statement about overcoming adversity.',
  rating: 4.6,
  plays: '2.5M',
  ...
  trackList: [
    {
      ...
      story: "The opening track sets the tone with haunting melodies and raw lyrics about emotional scars."
    },
    {
      id: 2,
      ...
      featuring: "SZA",
      spotifyId: "your_spotify_id",
      story: "A powerful collaboration with SZA about vulnerability and strength in the face of pain."
    },
    {
      id: 3,
      title: "Healing Process",
      spotifyId: "your_spotify_id",
      story: "An introspective track about the journey of self-healing and personal growth."
    }
  ],
  albumTeasers: {
    videos: [
      ...
      {
        url: "https://www.youtube.com/embed/your_video_id",
        title: "Scars Music Video"
      }
    ]
  },
  analysis: {
    overview: `"Alligator Bites Don't Heal" marks DoeChii's powerful entrance into the hip-hop scene. The album weaves together personal trauma, emotional healing, and artistic expression in a way that feels both deeply personal and universally relatable.`,
    keyPoints: [
      {
        title: "Emotional Authenticity",
        description: "DoeChii's raw and unfiltered approach to storytelling creates an immediate connection with listeners, making her experiences feel both personal and universal."
      },
      {
        title: "Musical Innovation",
        description: "The album blends traditional hip-hop elements with experimental production, creating a unique sound that defies genre boundaries."
      },
      {
        title: "Cultural Impact",
        description: "As an independent artist, DoeChii's success with this album represents a significant moment for women in hip-hop and the power of authentic storytelling."
      }
    ]
  },
  reviews: [
  ...
  concerts: [
    {
      id: 1,
      title: "Healing Tour 2024",
      venue: "The Fillmore, San Francisco",
      date: "2024",
      videoUrl: "https://www.youtube.com/embed/your_video_id",
      thumbnail: "/images/concerts/sf.jpg"
    }
  ],
  behindTheScenes: [
    {
      id: 1,
      title: "Making of Alligator Bites Don't Heal",
      description: "An intimate look at the creative process behind the album",
      videoUrl: "https://www.youtube.com/embed/your_video_id",
...
export default function AlligatorBitesDontHealAlbum() {
  const router = useRouter();
  const [isPlaying, setIsPlaying] = useState(false);
  const [currentTrackIndex, setCurrentTrackIndex] = useState(0);
  const [selectedTrack, setSelectedTrack] = useState(albumData.trackList[0]);
  const toast = useToast();
  const backgroundUrl = 'https://example.com/alligator-bites-dont-heal-background.jpg'; // Placeholder for background image
